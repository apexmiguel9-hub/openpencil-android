...
///
/// For stateless queries without bidirectional communication.
/// For multi-turn conversations, use [`crate::client::ClaudeSDKClient`] instead.
///
...
/// }
/// ```
#[must_use = "query returns a stream that must be consumed to receive messages"]
pub async fn query(
